...
<body>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="mb-0">Delivery Managers List</h3>
        
        <div class="d-flex align-items-center">
            <c:if test="${not empty deliveryManager}">
                <div class="manager-count-badge mr-3">
                    <i class="fas fa-users"></i> Total Managers: ${fn:length(deliveryManager)}
                </div>
            </c:if>
            
            <a href="${pageContext.request.contextPath}/admin/createDeliveryManager.jsp" class="btn btn-add">
                        ...
                        <tr>
                            ...
                            <td data-label="Password">
                                <div class="password-field">
                                    ...
                                    <span class="actual-password" style="display:none;">${dmanager.password}</span>
                                </div>
                            </td>
