...
<head>
    ...
    <title>Add Inventory Manager</title>
...
<body>
    ...
    <div class="form-container">
        <h3>Create Inventory Manager</h3>

        <form action="../addInventoryManager" method="post" onsubmit="return validateForm()">
            ...
            <!-- Submit Button -->
            <button type="submit" class="btn-submit">Create Inventory Manager</button>
        </form>
    </div>
