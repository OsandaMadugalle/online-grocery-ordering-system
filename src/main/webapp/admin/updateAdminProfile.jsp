	...
	<body>
	    ...
	    <div class="edit-container">
	        ...
	        <form action="../updateAdmin" method="post" onsubmit="return validateForm()">
	            ...
	            <!-- First Name -->
	            <div class="form-group">
	                <input type="text" class="form-control" name="firstName" placeholder="First Name" value="<%=fName %>" required>
	            </div>
	
	            <!-- Last Name -->
	            <div class="form-group">
	                <input type="text" class="form-control" name="lastName" placeholder="Last Name" value="<%=lName %>" required>
	            </div>
	
	            <!-- Phone -->
	            <div class="form-group">
	                <input type="tel" class="form-control" name="phone" placeholder="Phone" value="<%=phone %>"  required>
	            </div>
	            ...
	            <!-- Confirm Password -->
	            <div class="form-group">
	                <input type="password" class="form-control" id="confirmPassword" placeholder="Re-type Password" value="<%=password %>" required>
