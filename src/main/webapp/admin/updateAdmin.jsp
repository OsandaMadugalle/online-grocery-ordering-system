    ...
    <div class="edit-container">
        ...
        <form action="UpdateAdminServlet" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
            ...
            <div class="form-group">
                <input type="text" class="form-control" name="username" value="admin_user" required>
            </div>
            ...
            <!-- Phone Number -->
            <div class="form-group">
                <input type="tel" class="form-control" name="phone" value="9876543210" pattern="[0-9]{10}" required>
            </div>
