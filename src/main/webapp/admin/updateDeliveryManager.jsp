...
<%@ page import="com.gos.model.DeliveryManager" %>
<%@ page session="true" %>
...
<%
	DeliveryManager manager = (DeliveryManager) request.getAttribute("manager");
    if (manager == null) {
        response.sendRedirect(request.getContextPath() + "/updateDeliveryManager");
        return;
    }
%>
...
<head>
    ...
    <title>Update Delivery Manager</title>
...
<body>
    <a href="./manageDeliveryManager" class="home-icon">
        <i class="fas fa-arrow-left"></i>
    </a>

    <div class="form-container">
        <h3>Update Delivery Manager</h3>
