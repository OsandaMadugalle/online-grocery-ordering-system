...
<head>
    ...
    <style>
        ...
        .delivery-manager-btn {
            ...
            font-size: 16px;
            font-weight: 500;
            border: 2px solid #99cc00; /* Lime green border */
            color: #99cc00; /* Lime green text */
            background-color: transparent;
            transition: background-color 0.3s ease;
        }

        .delivery-manager-btn:hover {
            background-color: rgba(153, 204, 0, 0.2); /* Light lime green hover effect */
        }

        .delivery-manager-btn.active {
            background-color: #99cc00; /* Solid lime green background */
        ...
        .left-side-delivery {
            background-color: #005555; /* Deep teal background for Delivery Manager */
        }
